...
const DATA = {
  ...
  festivals:[
    // July
    {name:"Lowertown Sounds",detail:"Thursday evenings · Mears Park · Free · through July",neighborhood:"Lowertown",
      note:"Free outdoor concert series in Mears Park every Thursday evening through July. Local and regional acts, food trucks, community feel.",url:"https://www.lowertownsounds.com"},
    {name:"Hopkins Raspberry Festival",detail:"July 14–18 · Hopkins",neighborhood:"Hopkins",
      note:"Five days celebrating Hopkins's history as the Raspberry Capital of the World. Parade, carnival, live music, and the coronation of the Raspberry Queen.",url:"https://www.raspberrycapital.com"},
    {name:"Lumberjack Days",detail:"July 17–19 · Lowell Park · Stillwater",neighborhood:"Stillwater",
      note:"A 92-year Stillwater tradition. Parade, live music on the riverfront, and activities for all ages on the banks of the St. Croix.",url:"https://lumberjackdays.com"},
    {name:"Minneapolis International Festival",detail:"July 25 · Lake Harriet · Free",
      note:"Live music, dance, cultural exhibits. Very local, multigenerational.",url:"https://www.minneapolisparks.org/activities-events/events/minneapolis_international_festival/"},
    {name:"Minneapolis Aquatennial",detail:"Late July · Free · Downtown + lakes",
      note:"Minneapolis's signature summer celebration. Torchlight Parade, milk carton boat races on Bde Maka Ska, fireworks over the river.",url:"https://aquatennial.com"},
    // August
    {name:"Minnesota Fringe Festival",detail:"Aug 6–16 · Multiple venues",
      note:"1,000+ artists, 500+ performances across 11 days. The largest performing arts fringe in the Midwest and the largest nonjuried festival in the US. Buy a Button — it's your ticket to everything.",url:"https://minnesotafringe.org"},
    {name:"Uptown Art Fair",detail:"Aug 7–9 · Free · Lake of the Isles Pkwy",
      note:"300 artists on the parkway bordering CID and Kenwood. The fair draws the neighborhood out — you see exactly who lives here.",url:"https://www.uptownminneapolis.com/uptown-art-fair/"},
    {name:"Powderhorn Art Fair",detail:"Aug 15–17 · Free · Powderhorn Park",
      note:"More community-rooted than Uptown. More diverse.",url:"https://powderhornartfair.com"},
    {name:"Open Streets Uptown",detail:"Aug 24 · Lyndale Ave 22nd–42nd",
      note:"Lyndale Ave goes car-free. Walk the spine of the neighborhood without a windshield.",url:"https://www.ourstreetsmn.org/events/open-streets/"},
    {name:"Minnesota State Fair",detail:"Aug 28–Sept 7 · Fairgrounds",
      note:"1.9M visitors. The ritual that makes Minneapolis locals out of newcomers. Go at least once.",url:"https://mnstatefair.org"},
  ],
  cinema:[
  ...
  performances:[
    ...
    {name:"Lake Harriet Bandshell",detail:"Sundays all summer · Free",note:"Free concerts every Sunday evening. Blanket on the grass. Shows up every Sunday and becomes essential.",url:"https://www.minneapolisparks.org/activities-events/music-movies-parks/"},
  ...
  exhibitions:[
    ...
    {name:"Mill City Museum",detail:"704 S 2nd St · Mill District",note:"Carved out of the ruins of the world's largest flour mill. Minneapolis's own story told in the building where it happened.",url:"https://www.mnhs.org/millcity"},
  ...
  // GATHER
  classes:[
    {name:"Cooks of Crocus Hill",detail:"210 N 1st St · North Loop · Cooking school",neighborhood:"Mac-Groveland",note:"The North Loop location is now entirely a cooking school. Classes range from knife skills to full-day Italian workshops. Date nights, team events, guest chefs.",url:"https://cooksofcrocushill.com"},
    {name:"France 44 Wines & Spirits",detail:"4351 France Ave S · South Minneapolis",neighborhood:"Linden Hills",note:"Wine and spirits classes in South Minneapolis. Fresh mozzarella, stuffed pastas, pizza nights.",url:"https://france44.com"},
  ...
  markets:[
    ...
    {name:"Minneapolis Farmers Market",detail:"Sat–Sun 6am–1pm · 312 E Lyndale · Largest",neighborhood:"Lowry Hill",
    ...
    {name:"Markets on Main",detail:"Sun 10am–2pm · 1 SE Main St · SAM",neighborhood:"St. Anthony Main",
      note:"Right in St. Anthony Main. Local food, vintage, makers on Riverplace Plaza with the best downtown river views.",url:"https://www.marketsonmainmpls.com"},
    {name:"East Isles Market",detail:"Thu 4–8pm · MoZaic, Lagoon & Girard · Weekday",neighborhood:"East Isles",
      note:"The most CID-adjacent weekday market. A preview of what Thursdays look like if you buy in the neighborhood.",url:"https://uptownmarket.org"},
    {name:"Linden Hills Market",detail:"Sun 10am–1pm · 2813 W 43rd · Hyper-local",neighborhood:"Linden Hills",
      note:"Small, community-rooted, rain or shine. Exactly the crowd you'd be living among.",url:"https://www.lindenhillsfarmersmarket.org"},
    {name:"Midtown Farmers Market",detail:"Sat 9am–1pm · 2225 E Lake St · Community",neighborhood:"Whittier",
  ...
  makers:[
    ...
    {name:"Baker's Field",detail:"Northeast Minneapolis · Mill-to-table",neighborhood:"Northeast Arts District",
      note:"Grain milled on-site, baked daily. Minnesota-grown wheat.",url:"https://www.bakersfieldflourandbread.com"},
    {name:"Indeed Brewing",detail:"Northeast Minneapolis · Taproom + patio",neighborhood:"Logan Park",
    ...
    {name:"Bauhaus Brew Labs",detail:"Northeast Minneapolis · German-influenced",neighborhood:"Northeast Arts District",
      note:"German-influenced. The space is worth seeing.",url:"https://www.bauhausbrewlabs.com"},
    {name:"Kramarczuk's",detail:"215 E Hennepin Ave · NE Minneapolis · Since 1954",neighborhood:"St. Anthony Main",
    ...
    {name:"Broders' Cucina Italiana",detail:"50th & Penn · Southwest Minneapolis",neighborhood:"Fulton",
  ...
  coffee:[
    ...
    {name:"Dogwood Coffee",detail:"NE Minneapolis + multiple",neighborhood:"Northeast Arts District",
      note:"Precision roasting. Good single origins. The Northeast neighborhood café.",url:"https://www.dogwoodcoffee.com"},
    {name:"Spyhouse Coffee",detail:"Whittier + multiple locations · Institution",neighborhood:"Whittier",
      note:"Started in Whittier in 2000, now one of the city's most respected roasters. On-site roasting. Multiple neighborhood locations.",url:"https://www.spyhousecoffee.com"},
    ...
    {name:"Café Alma",detail:"St. Anthony Main · Cafe + Restaurant + Hotel",neighborhood:"St. Anthony Main",
      note:"Café Alma elevates casual dining with counter service and bar. Same Alex Roberts kitchen that earned a James Beard Award.",url:"https://www.almampls.com/cafe"},
    {name:"Five Watt Coffee",detail:"Kingfield · Multiple TC locations",neighborhood:"Kingfield",
      note:"Started in Kingfield in 2014. The original location at 3745 Nicollet is still the best — cocktail-inspired drinks, bitters, house syrups. Four locations now across Minneapolis and St. Paul.",url:"https://www.fivewattcoffee.com"},
    ...
    {name:"FRGMNT Coffee",detail:"North Loop / Mill District / St. Anthony Main",neighborhood:"North Loop",
    ...
    {name:"Mojo Coffee Gallery",detail:"Northeast Arts District · California Building",neighborhood:"Northeast Arts District",
      note:"Coffee inside one of Northeast's original artist studio buildings. Breakfast and brunch too.",url:"https://www.mojocoffeegallery.com"},
    {name:"Nina's Coffee Café",detail:"Cathedral Hill · Selby Avenue",neighborhood:"Cathedral Hill",
      note:"The corner that's anchored the neighborhood's coffee culture for decades.",url:"https://ninascoffeecafe.online"},
  ...
  bakeries:[
    ...
    {name:"Honey & Rye",detail:"Linden Hills · Bakery + coffee bar",neighborhood:"Linden Hills",
      note:"Founded in 2013 in a former dry-cleaning shop near Bde Maka Ska. Laminated pastries, breads, soups, sandwiches, and a full espresso bar.",url:"https://bakehousemn.com/locations/honey-rye/"},
    {name:"Baker's Field",detail:"NE Minneapolis · Grain-to-loaf",
      note:"Grain milled on-site, baked daily. Minnesota-grown wheat."},
    {name:"Rustica Bakery",detail:"Multiple locations · Minneapolis",neighborhood:"East Isles",
  ...
  restaurants:[
    // Been there
    {name:"Rosalia",detail:"Linden Hills · Been there",neighborhood:"Linden Hills",
    ...
    {name:"Le Burger 4304",detail:"Linden Hills · Been there",neighborhood:"Linden Hills",
    ...
    {name:"Colita",detail:"Linden Hills · Been there",neighborhood:"Linden Hills",
    ...
    // Want to try
    {name:"Vinai",detail:"North Loop · Want to try · Book ahead",neighborhood:"North Loop",
    ...
    {name:"Spoon and Stable",detail:"North Loop · Want to try · James Beard",neighborhood:"North Loop",
      note:"Gavin Kaysen's flagship. The room is worth it. Get the bison tartare.",url:"https://www.spoonandstable.com"},
    {name:"Porzana",detail:"North Loop · Want to try · Date night",neighborhood:"North Loop",
    ...
    {name:"Jook Sing at Steady Pour",detail:"NE Minneapolis · Want to try",neighborhood:"Northeast Arts District",
    ...
    {name:"Mama Safia's Kitchen",detail:"Lake Street · Want to try · Institution",neighborhood:"Whittier",
    ...
    {name:"Mestiizo",detail:"Northeast · Want to try · Buzzy",neighborhood:"Northeast Arts District",
      note:"Mexican-Asian fusion. The Nameless Martini (yuzu gin + tepache vermouth). Order it.",url:"https://mestiizo.com"},
    {name:"World Street Kitchen",detail:"Lyndale Ave · Want to try",neighborhood:"Whittier",
  ...
  movement:[
    ...
    {name:"Club Pilates Minneapolis Lakes",detail:"East Isles · W. Lake Street · Reformer",neighborhood:"East Isles",
      note:"National studio with a strong local following. Reformer, Springboard, and Suspend classes steps from the Chain of Lakes.",url:"https://www.clubpilates.com/location/minneapolislakes"},
    {name:"Mov Hot Yoga",detail:"East Isles · W. Lake Street · Hot yoga",neighborhood:"East Isles",
      note:"Hot yoga, barre, and FIT classes steps from Lake of the Isles. A consistent neighborhood favorite.",url:"https://www.movhotyoga.com"},
    {name:"Loppet Foundation",detail:"Community paddling + winter trails",neighborhood:"Logan Park",
  ...
  nature:[
    ...
    {name:"Lake Harriet",detail:"2.8mi loop · Bandshell",neighborhood:"Linden Hills",
      note:"Swimming beach, sailing club, paddleboat rentals. Free Sunday concerts at the Bandshell all summer.",url:"https://www.minneapolisparks.org/parks-destinations/parks-lakes/lake_harriet_park/"},
    ...
    {name:"Lake Minnetonka",detail:"Day trip · 30 min from BMS",neighborhood:"Excelsior",
    ...
    {name:"Beard\'s Plaisance",detail:"Linden Hills · Lake Harriet",neighborhood:"Linden Hills",
      note:"A sloping lawn above Lake Harriet that fills with picnic blankets on summer evenings. The quiet counterpart to the busy beach.",url:"https://www.minneapolisparks.org/parks-destinations/parks-lakes/lake_harriet_park/"},
    {name:"Bohemian Flats",detail:"Cedar-Isles-Dean · River launch",neighborhood:"Cedar-Isles-Dean",
      note:"A flat park at river level below the Washington Ave bridge. Kayak launch, morning fog, and almost no one after 8am.",url:"https://www.minneapolisparks.org/parks-destinations/parks-lakes/bohemian_flats_park/"},
    {name:"Gold Medal Park",detail:"Mill District · Mound with views",neighborhood:"Mill District",
      note:"A small spiral-mound park next to the Guthrie with 360° views of the river and downtown. Almost no one stops here.",url:"https://www.goldmedalpark.org"},
    ...
    {name:"Cathedral Hill Park",detail:"Cathedral Hill · Cathedral overlook",neighborhood:"Cathedral Hill",
      note:"A small green space acquired in 1979 to preserve an unobstructed view of the Cathedral of Saint Paul. Quiet, historic, walkable from Summit Avenue.",url:"https://www.stpaul.gov/facilities/cathedral-hill-park"},
  ],
  wellness:[
    ...
    {name:"Cedar & Stone at Four Seasons",detail:"North Loop · Rooftop · Guided Nordic sauna",neighborhood:"North Loop",
      note:"75-minute guided sauna ritual on the 4th-floor rooftop terrace of the Four Seasons. Electric and wood-fired saunas, cold plunge, skyline views. The most elevated sauna experience in the city.",url:"https://cedarandstonesauna.com/sauna-with-us/minneapolis-flagship-location/"},
    // Communal bathing & full-service spa
    {name:"Watershed Spa",detail:"St. Anthony Main · Communal bathing + full spa",neighborhood:"St. Anthony Main",
      note:"Ritual-based communal bathing in a converted 19th-century switch house on the Mississippi. Steam room, sauna, cold plunge, soaking tubs. Massage, acupuncture, and energy work. Books out weeks ahead — membership is the move.",url:"https://www.watershedspa.com"},
    // Salt therapy
    {name:"The Salt Cave Minneapolis",detail:"Tangletown · Halotherapy · 4811 Nicollet Ave",neighborhood:"Tangletown",
      note:"Six tons of Himalayan pink salt built into a therapeutic cave. Pharmaceutical-grade aerosolized salt blown through the room. Zero-gravity chairs. The first salt cave in Minnesota.",url:"https://www.saltcaveminnesota.com"},
    // SUP & on-water wellness
