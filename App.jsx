...
const DATA = {
  ...
  festivals:[
    ...
    {name:"Minnesota Fringe Festival",detail:"Aug 6–16 · Multiple venues",note:"1,000+ artists, 500+ performances across 11 days. The largest performing arts fringe in the Midwest and the largest nonjuried festival in the US. Buy a Button — it's your ticket to everything.",url:"https://minnesotafringe.org"},
    ...
    {name:"Mill City Farmers Market Opening Day",detail:"May · Mill District",neighborhood:"Mill District",note:"The market's opening weekend draws the whole neighborhood. The first Saturday of the season has an energy the rest don't.",url:"https://millcityfarmersmarket.org"},
    {name:"Twin Cities Jazz Festival",detail:"June 19–20 · Mears Park · Lowertown · Free",note:"National headliners and local legends in Lowertown's best outdoor space. One of the strongest free jazz events in the country.",url:"https://www.twincitiesjazzfestival.com"},
    {name:"Grand Old Day",detail:"June 7 · Grand Avenue · Mac-Groveland · Free",note:"The largest single-day event in the Midwest — Grand Avenue goes car-free from Snelling to Dale. Live music on multiple stages, parade, art fair.",url:"https://www.grandave.com/events/grandoldday"},
    {name:"Lowertown Sounds",detail:"Thursday evenings · Mears Park · Free · June–July",note:"Free outdoor concert series in Mears Park every Thursday evening. Local and regional acts, food trucks, community feel.",url:"https://www.lowertownsounds.com"},
    {name:"Excelsior Art on the Lake",detail:"June 13–14 · Water Street · Excelsior · Free",note:"130+ juried artists on the banks of Lake Minnetonka. A genuine fine art show, not a craft market. Live music all weekend.",url:"https://www.excelsiorlakeminnetonkachamber.com/art-on-the-lake/"},
    {name:"Lumberjack Days",detail:"July 17–19 · Lowell Park · Stillwater",note:"A 92-year Stillwater tradition. Parade, live music on the riverfront, and activities for all ages on the banks of the St. Croix.",url:"https://lumberjackdays.com"},
    {name:"Hopkins Raspberry Festival",detail:"July 14–18 · Hopkins",note:"Five days celebrating Hopkins's history as the Raspberry Capital of the World. Parade, carnival, live music, and the coronation of the Raspberry Queen.",url:"https://www.raspberrycapital.com"},
  ],
  cinema:[
